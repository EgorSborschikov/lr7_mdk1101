...
users = [
    ...
    add_if_not_exists(session, User, last_name='Сидоров', first_name='Сидор', middle_name='Сидорович', gender=genders[0], birth_date=datetime.date(1980, 8, 20), user_type=user_types[0], territory=territories[2], settlement=settlements[2], jwt=jwt_tokens[2], email='sidorov@example.com'),
    ...
    add_if_not_exists(session, User, last_name='Смирнов', first_name='Смир', middle_name='Смирович', gender=genders[0], birth_date=datetime.date(1992, 3, 5), user_type=user_types[0], territory=territories[4], settlement=settlements[4], jwt=jwt_tokens[4], email='smirnov@example.com'),
    ...
    add_if_not_exists(session, User, last_name='Попов', first_name='Поп', middle_name='Попович', gender=genders[0], birth_date=datetime.date(1995, 11, 30), user_type=user_types[0], territory=territories[1], settlement=settlements[6], jwt=jwt_tokens[6], email='popov@example.com'),
    add_if_not_exists(session, User, last_name='Соколов', first_name='Сокол', middle_name='Соколович', gender=genders[0], birth_date=datetime.date(1983, 4, 18), user_type=user_types[1], organization_name='ООО "Соколов"', territory=territories[2], settlement=settlements[7], jwt=jwt_tokens[7], email='sokolov@example.com'),
    ...
    add_if_not_exists(session, User, last_name='Новиков', first_name='Новик', middle_name='Новикович', gender=genders[0], birth_date=datetime.date(1987, 9, 22), user_type=user_types[1], organization_name='ООО "Новиков"', territory=territories[4], settlement=settlements[9], jwt=jwt_tokens[9], email='novikov@example.com')
]
session.commit()
